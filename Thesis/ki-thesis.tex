...
\newcommand{\nazevcz}{\ZT{Prototyp aplikace pro zobrazení digitálních dvojčat stavebních projektů v rozšířené realitě}}        % zde VYPLŇTE český název práce (přesně podle zadání!)
\newcommand{\nazeven}{\ZT{Prototype of an Application for Displaying Digital Twins of Construction Projects in Augmented Reality}}     % zde VYPLŇTE anglický název práce (přesně podle zadání!)
\newcommand{\autor}{\ZT{Radek Šmejkal}}
\newcommand{\rok}{\the\year}                
\newcommand{\vedouci}{\ZT{Ing. Mgr. Pavel Beránek}}         
% zde VYPLŇTE jméno a příjmení vedoucího práce, včetně titulů
\newcommand{\vedouciDAT}{\ZT{Ing. Mgr. Pavlu Beránkovi}}   
